...
(function() {
	...
	function init() {
		var showMenu = document.getElementById( 'showMenu' ),
			...
			perspective_container = perspectiveWrapper.querySelector( '.perspective_container' ),
			contentWrapper = perspective_container.querySelector( '.wrapper' );
		...
		closeMenu.addEventListener( clickevent, function( ev ) {
